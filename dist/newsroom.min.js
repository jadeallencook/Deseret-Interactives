...
/***/ "../../../../usr/local/lib/node_modules/webpack/node_modules/constants-browserify/constants.json":
/*!******************************************************************!*\
  !*** (webpack)/node_modules/constants-browserify/constants.json ***!
  \******************************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.js */ \"./src/scripts/list.js\");\n/* harmony import */ var _timeline_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./timeline.js */ \"./src/scripts/timeline.js\");\n/* harmony import */ var _navigational_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navigational.js */ \"./src/scripts/navigational.js\");\n/* harmony import */ var _faqs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./faqs.js */ \"./src/scripts/faqs.js\");\n/* harmony import */ var _bullets_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./bullets.js */ \"./src/scripts/bullets.js\");\n/* harmony import */ var _slideshow_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./slideshow.js */ \"./src/scripts/slideshow.js\");\n/* harmony import */ var _choropleth_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./choropleth.js */ \"./src/scripts/choropleth.js\");\n/* harmony import */ var _lineGraph_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lineGraph.js */ \"./src/scripts/lineGraph.js\");\n/* harmony import */ var _profile_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./profile.js */ \"./src/scripts/profile.js\");\n/* harmony import */ var _guessingGame_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./guessingGame.js */ \"./src/scripts/guessingGame.js\");\n// import new interactives here\n\n\n\n\n\n\n\n\n\n\n\nwindow.Newsroom = {\n    parameter: function (interactive, parameter) {\n        return interactive.getAttribute('data-' + parameter);\n    },\n    ajax: function (src) {\n        return new Promise(function (res, rej) {\n            var request = new XMLHttpRequest;\n            request.onload = function () {\n                res(JSON.parse(this.response));\n            }\n            request.open('get', src);\n            request.send();\n        })\n    },\n    init: function () {\n        var interactives = document.getElementsByClassName('interactive');\n        for (var x = 0; x < interactives.length; x++) {\n            var interactive = interactives[x],\n                type = interactive.getAttribute('data-type');\n            if (!type) console.warn('Newsroom Interactives: There was no type set for the interactive.');\n            else if (type === 'list') new _list_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](interactive, Newsroom.parameter(interactive, 'src'), Newsroom.parameter(interactive, 'style'));\n            else if (type === 'timeline') new _timeline_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](interactive, Newsroom.parameter(interactive, 'src'), Newsroom.parameter(interactive, 'color'), Newsroom.parameter(interactive, 'title'), Newsroom.parameter(interactive, 'height'));\n            else if (type === 'navigational') new _navigational_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](interactive, Newsroom.parameter(interactive, 'json'));\n            else if (type === 'faqs') new _faqs_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](interactive, Newsroom.parameter(interactive, 'menuImage'), Newsroom.parameter(interactive, 'json'));\n            else if (type === 'bullets') new _bullets_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](interactive, Newsroom.parameter(interactive, 'color'), Newsroom.parameter(interactive, 'title'), Newsroom.parameter(interactive, 'json'));\n            else if (type === 'slideshow') new _slideshow_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"](interactive, Newsroom.parameter(interactive, 'title'), Newsroom.parameter(interactive, 'color'), Newsroom.parameter(interactive, 'json'));\n            else if (type === 'choropleth') new _choropleth_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"](interactive, Newsroom.parameter(interactive, 'usm'));\n            else if (type === 'lineGraph') new _lineGraph_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"](interactive, Newsroom.parameter(interactive, 'json'));\n            else if (type === 'profile') new _profile_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"](interactive, Newsroom.parameter(interactive, 'color'), Newsroom.parameter(interactive, 'allLink'), Newsroom.parameter(interactive, 'allText'), Newsroom.parameter(interactive, 'json'));\n\t\t\telse if (type === 'guessingGame') new _guessingGame_js__WEBPACK_IMPORTED_MODULE_9__[\"default\"](interactive, Newsroom.parameter(interactive, 'json'));\n\t\t\telse console.warn('Newsroom Interactives: There was no type set for the interactive.');\n        }\n    },\n    rapid: function () {\n        // append\n        this.a = function (container, elem) {\n            container.appendChild(elem);\n        }\n        // create \n        this.c = function (elems, text) {\n            var elem = null;\n            if (Array.isArray(elems)) {\n                var container = document.createElement(elems[0]);\n                for (var x = 1; x < elems.length; x++) {\n                    var elem = document.createElement(elems[x]);\n                    container.appendChild(elem);\n                }\n                return container;\n            } else {\n                var elem \n                if (elems.includes('.')) {\n                    var className = elems.substr(elems.indexOf('.') + 1),\n                    elemName = elems.substr(0, elems.indexOf('.')); \n                    elem = document.createElement(elemName);\n                    elem.classList.add(className);\n                } else if (elems.includes('#')) {\n                    var id = elems.substr(elems.indexOf('#') + 1),\n                    elemName = elems.substr(0, elems.indexOf('#')); \n                    elem = document.createElement(elemName);\n                    elem.setAttribute('id', id);\n                } else {\n                    elem = document.createElement(elems);\n                }\n                if (text) elem.innerHTML = text;\n                return elem;\n            }\n        }\n        // each\n        this.e = function (array, callback) {\n            var num;\n            if (array.length) num = array.length;\n            else num = array;\n            for (var x = 0; x < num; x++) {\n                var value;\n                if (!array[x]) value = num - x;\n                else value = array[x];\n                callback(value);\n            }\n        }\n        // prepend\n        this.p = function(container, elem) {\n            container.prepend(elem);\n        }\n        // min & max\n        this.min = function (array) {\n            return Math.min.apply(Math, array);\n        }\n        this.max = function (array) {\n            return Math.max.apply(Math, array);\n        }\n    }\n}\n\n//# sourceURL=webpack:///./src/scripts/app.js?");

/***/ }),

/***/ "./src/scripts/bullets.js":
/*!********************************!*\
  !*** ./src/scripts/bullets.js ***!
  \********************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return GuessingGame; });\n/* harmony import */ var _libs_PhotoSwipe_photoswipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/PhotoSwipe/photoswipe */ \"./src/libs/PhotoSwipe/photoswipe.js\");\n/* harmony import */ var _libs_PhotoSwipe_photoswipe__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_libs_PhotoSwipe_photoswipe__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _libs_PhotoSwipe_photoswipe_ui_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/PhotoSwipe/photoswipe-ui-default */ \"./src/libs/PhotoSwipe/photoswipe-ui-default.js\");\n/* harmony import */ var _libs_PhotoSwipe_photoswipe_ui_default__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_libs_PhotoSwipe_photoswipe_ui_default__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nfunction GuessingGame(container, json) {\n    Newsroom.ajax(json).then(function (json) {\n\n        var photoswipeUI = '<div class=\"pswp\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\"><div class=\"pswp__bg\"></div><div class=\"pswp__scroll-wrap\"> <div class=\"pswp__container\"> <div class=\"pswp__item\"></div><div class=\"pswp__item\"></div><div class=\"pswp__item\"></div></div><div class=\"pswp__ui pswp__ui--hidden\"> <div class=\"pswp__top-bar\"> <div class=\"pswp__counter\"></div><button class=\"pswp__button pswp__button--close\" title=\"Close (Esc)\"></button> <button class=\"pswp__button pswp__button--share\" title=\"Share\"></button> <button class=\"pswp__button pswp__button--fs\" title=\"Toggle fullscreen\"></button> <button class=\"pswp__button pswp__button--zoom\" title=\"Zoom in/out\"></button> <div class=\"pswp__preloader\"> <div class=\"pswp__preloader__icn\"> <div class=\"pswp__preloader__cut\"> <div class=\"pswp__preloader__donut\"></div></div></div></div></div><div class=\"pswp__share-modal pswp__share-modal--hidden pswp__single-tap\"> <div class=\"pswp__share-tooltip\"></div></div><button class=\"pswp__button pswp__button--arrow--left\" title=\"Previous (arrow left)\"> </button> <button class=\"pswp__button pswp__button--arrow--right\" title=\"Next (arrow right)\"> </button> <div class=\"pswp__caption\"> <div class=\"pswp__caption__center\"></div></div></div></div></div>';\n        container.innerHTML = photoswipeUI;\n\n        var R = new Newsroom.rapid,\n            pswpElement = document.querySelectorAll('.pswp')[0];\n\n        document.onclick = clear;\n        document.onscroll = clear;\n\n        function clear() {\n            if (pswpElement.getAttribute('aria-hidden') !== 'false') {\n                do {\n                    var test = false;\n                    R.e(container.children, function (elem) {\n                        if (elem.nodeName === 'IMG' && !elem.classList.contains('gallary-preview')) {\n                            elem.remove();\n                            test = true;\n                        }\n                    });\n                } while (test);\n            }\n        }\n\n        function importCSS(file) {\n            return new Promise(function (res) {\n                var head = document.head,\n                    elem = document.createElement('link');\n                elem.type = \"text/css\";\n                elem.rel = \"stylesheet\";\n                elem.href = file;\n                head.appendChild(elem);\n                res();\n            });\n        }\n\n        importCSS('../src/libs/PhotoSwipe/photoswipe.css');\n        importCSS('../src/libs/PhotoSwipe/default-skin/default-skin.css');\n\n        var promises = [],\n            items = [];\n        R.e(json, function (image) {\n            promises.push(new Promise(function (res) {\n                var temp = new Image();\n                temp.src = image;\n                image = temp;\n                image.onload = function () {\n                    items.push({\n                        src: this.src,\n                        w: this.width,\n                        h: this.height\n                    });\n                    res();\n                };\n            }));\n        });\n\n\n        Promise.all(promises).then(function () {\n            R.e(json, function (image) {\n                var elem = R.c('img');\n                elem.src = image;\n                elem.classList.add('gallary-preview');\n                R.a(container, elem);\n                elem.onclick = gallery;\n            });\n            var submitBtn = R.c('button.submit-answers', 'Submit answers');\n            R.a(container, submitBtn);\n        });\n\n        function gallery() {\n            R.e(json, function (image) {\n                var elem = R.c('img');\n                elem.src = image;\n                R.a(container, elem);\n            });\n            var options = {\n                history: false,\n                focus: false,\n                showAnimationDuration: 0,\n                hideAnimationDuration: 0\n            }\n            var gallery = new _libs_PhotoSwipe_photoswipe__WEBPACK_IMPORTED_MODULE_0___default.a(pswpElement, _libs_PhotoSwipe_photoswipe_ui_default__WEBPACK_IMPORTED_MODULE_1___default.a, items, options);\n            gallery.init();\n        }\n\n    });\n}\n\n//# sourceURL=webpack:///./src/scripts/guessingGame.js?");

/***/ }),

/***/ "./src/scripts/lineGraph.js":
/*!**********************************!*\
  !*** ./src/scripts/lineGraph.js ***!
  \**********************************/
/*! exports provided: default */
